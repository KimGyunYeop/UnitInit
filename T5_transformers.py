...
class UnitInitLayerBeforeDotproduct(nn.Module):
    def __init__(self, original_layer, num_heads, head_indi=True, init_type="unit", act_type=None) -> None:
        ...
        self.original_layer = original_layer
        self.num_heads = num_heads
        self.head_indi = head_indi
        
        self.added_layer_dim = original_layer.out_features
    ...
    def forward(self, x):
        ...
        ori_x_shape = x.size()
        new_x_shape = ori_x_shape[:-1] + (self.num_heads, -1)
...
class T5Attention(nn.Module):
    ...
    def add_unit_init_before_dotpro(self, head_indi=True, init_type="unit", act_type=None):
        self.added_q = UnitInitLayerBeforeDotproduct(self.q, num_heads=self.n_heads, head_indi=head_indi, init_type=init_type, act_type=act_type)
        self.added_k = UnitInitLayerBeforeDotproduct(self.k, num_heads=self.n_heads, head_indi=head_indi, init_type=init_type, act_type=act_type)
        self.added_v = UnitInitLayerBeforeDotproduct(self.v, num_heads=self.n_heads, head_indi=head_indi, init_type=init_type, act_type=act_type)
