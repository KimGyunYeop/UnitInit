...
class DisentangledSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if hasattr(self, "added_query_proj"):
            query_layer = self.transpose_for_scores(self.added_query_proj(query_states), self.num_attention_heads)
            key_layer = self.transpose_for_scores(self.added_key_proj(hidden_states), self.num_attention_heads)
            value_layer = self.transpose_for_scores(self.added_value_proj(hidden_states), self.num_attention_heads)
        else:
